...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center px-10 py-1 bg-gradient-to-r from-black  to-gray-500   md:bg-gradient-to-r md:from-gray-500  md:to-black">
